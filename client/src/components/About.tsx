...
const About = () => {
  ...
  return (
    <section id="about" ref={sectionRef} className="py-20 bg-white dark:bg-gray-900 transition-colors duration-300 animate-fade-in">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <h2 className="text-3xl font-bold font-sans text-gray-900 dark:text-white mb-4">About Me</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold font-sans text-gray-900 dark:text-white">My Story</h3>
            <p className="text-gray-700 dark:text-gray-300">
            ...
            <div className="pt-4">
              <h4 className="text-xl font-semibold font-sans text-gray-900 dark:text-white mb-3">Professional Goals</h4>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 shadow-md space-y-6">
            <div>
              <h4 className="text-xl font-semibold font-sans text-gray-900 dark:text-white mb-3">Personal Details</h4>
            ...
            <div>
              <h4 className="text-xl font-semibold font-sans text-gray-900 dark:text-white mb-3">Interests</h4>
            ...
            <div>
              <h4 className="text-xl font-semibold font-sans text-gray-900 dark:text-white mb-3">Download</h4>
              <a 
                href="#" 
